...
def init_serial():
    ...
    ser.baudrate = 9600
    ser.bytesize = 8
    ser.port = "COM6"  # Replace with your actual COM port
    ser.timeout = 10
    ser.open()
...
class Face_Recognizer:
    ...
    def attendance(self, name):
        if name != "unknown":
            ser.write(b'1')
            print(f"{name} recognized and '1' sent via COM port")
        else:
            ser.write(b'2')
            print(f"Unknown face or no face detected and '2' sent via COM port")
            ...
            while stream.isOpened():
                ...
                if (self.current_frame_face_cnt == self.last_frame_face_cnt) and (
                    ...
                    if self.current_frame_face_cnt == 0:
                        ...
                        self.current_frame_face_name_list = []
                        ser.write(b'2')  # No face detected, send 'z'
